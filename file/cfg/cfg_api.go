...
// GetVar returns a vvar.Var with value by given <pattern>.
func (c *Config) GetVar(pattern string, def ...interface{}) *vvar.Var {
	if j := c.getJson(); j != nil {
...
// GetGTime retrieves the value by specified <pattern> and converts it to *vtime.Time.
func (c *Config) GetVTime(pattern string, format ...string) *vtime.Time {
	if j := c.getJson(); j != nil {
		return j.GetVTime(pattern, format...)
	}
	return nil
}
...
func (c *Config) GetJson(pattern string, def ...interface{}) *json.Json {
	if j := c.getJson(); j != nil {
...
func (c *Config) GetJsons(pattern string, def ...interface{}) []*json.Json {
	if j := c.getJson(); j != nil {
...
func (c *Config) GetJsonMap(pattern string, def ...interface{}) map[string]*json.Json {
	if j := c.getJson(); j != nil {
