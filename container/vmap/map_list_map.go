...
type ListMap struct {
	mu   rwmutex.RWMutex
	data map[interface{}]*vlist.Element
	list *vlist.List
}
...
func NewListMap(safe ...bool) *ListMap {
	return &ListMap{
		...
		data: make(map[interface{}]*vlist.Element),
		list: vlist.New(),
	}
}
...
func (m *ListMap) IteratorAsc(f func(key interface{}, value interface{}) bool) {
	...
	if m.list != nil {
		...
		m.list.IteratorAsc(func(e *vlist.Element) bool {
...
func (m *ListMap) IteratorDesc(f func(key interface{}, value interface{}) bool) {
	...
	if m.list != nil {
		node := (*ListMapNode)(nil)
		m.list.IteratorDesc(func(e *vlist.Element) bool {
			node = e.Value.(*ListMapNode)
			return f(node.key, node.value)
		})
	}
...
func (m *ListMap) Clear() {
	m.mu.Lock()
	m.data = make(map[interface{}]*vlist.Element)
	m.list = vlist.New()
	m.mu.Unlock()
}
...
func (m *ListMap) Merge(other *ListMap) {
	...
	node := (*ListMapNode)(nil)
	other.list.IteratorAsc(func(e *vlist.Element) bool {
		node = e.Value.(*ListMapNode)
