...
func (s *StorageMemory) GetSession(id string, ttl time.Duration, data *vmap.StrAnyMap) (*vmap.StrAnyMap, error) {
	return data, nil
}
...
func (s *StorageMemory) SetSession(id string, data *vmap.StrAnyMap, ttl time.Duration) error {
	return nil
}
