...
// DoVar returns value from Do as vvar.Var.
func (r *Redis) DoVar(commandName string, args ...interface{}) (*vvar.Var, error) {
	return resultToVar(r.Do(commandName, args...))
}

// DoVarWithTimeout returns value from Do as vvar.Var.
// The timeout overrides the read timeout set when dialing the connection.
func (r *Redis) DoVarWithTimeout(timeout time.Duration, commandName string, args ...interface{}) (*vvar.Var, error) {
