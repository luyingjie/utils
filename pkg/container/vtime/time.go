...
import (
	...
	"github.com/luyingjie/utils/pkg/container/verror"
	util "github.com/luyingjie/utils/util"
...
func StrToTime(str string, format ...string) (*Time, error) {
	...
	if match[6] != "" {
		...
		if len(zone) <= 6 {
			...
			if h > 24 || m > 59 || s > 59 {
				return nil, verror.Newf("invalid zone string: %s", match[6])
			}
